...
class BookScannerPlugin {
    ...
    function download_image_to_media_library($image_url, $title) {
        ...
        switch ($content_type) {
            ...
            case 'image/gif':
                ...
                break;
            default:
                return new WP_Error('invalid_image_type', 'Type d’image non pris en charge.');
        }
        ...
        if ($upload['error']) {
            return new WP_Error('upload_error', 'Erreur lors de l’enregistrement de l’image.');
        }
